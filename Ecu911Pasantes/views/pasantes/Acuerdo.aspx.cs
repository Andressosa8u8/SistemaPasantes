    ...
    public partial class Acuerdo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (existe)
            {
                ...
                btnGuardar.CssClass = "btn btn-secondary disabled";
            }
        }
            ...
            if (ckbAcuerdo.Checked == true)
            {
                ...
                if (acuerdo != null)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "mensaje",
                        "swal({ " +
                        "  title: 'Éxito!', " +
                        "  text: 'Acuerdo aceptado con éxito.', " +
                        "  icon: 'success' " +
                        "}).then((value) => { " +
                        "  if (value) { " +
                        "    location.reload(); " +
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "mensaje",
                        "swal('Error!', 'No se pudo aceptar el acuerdo.', 'error')", true);
                }
            }
            else
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "mensaje",
                    "swal('Error!', 'No aceptado el acuerdo.', 'error')", true);
            }
        }
