                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegexValidatorCedula" runat="server" ControlToValidate="txtCedula"
                                        ...
                                        ErrorMessage="Solo se permiten hasta 10 dígitos y numeros entre 0-9"
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtDireccion" type="text" CssClass="form-control" placeholder="Ingrese la dirección" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <asp:TextBox ID="txtEmail" type="text" CssClass="form-control" placeholder="Ingrese el correo electronico" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
