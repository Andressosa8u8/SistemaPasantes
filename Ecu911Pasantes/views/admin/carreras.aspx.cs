...
namespace Ecu911Pasantes.views.admin
{
    public partial class carreras : System.Web.UI.Page
    {
        ...
        {
            var listaCarrera = dc.Cargarcarreras();
            if (listaCarrera != null)
            {
                grvCarreras.DataSource = listaCarrera;
        ...
        protected void grvCarreras_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("~/views/admin/carrera.aspx?cod=" + codigo, true);
            }
        ...
        protected void grvCarreras_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                string estado = DataBinder.Eval(e.Row.DataItem, "Carre_estado").ToString();
        ...
        {
            Response.Redirect("~/views/admin/carrera.aspx");
        }
    }
}