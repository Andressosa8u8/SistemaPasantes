                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:DropDownList ID="ddlRol" CssClass="form-control select2" data-toggle="select2" runat="server" required="true">
                                        <asp:ListItem Value="0">Seleccione un cargo</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" ForeColor="Red" runat="server" ErrorMessage="El rol es requerido" ControlToValidate="ddlRol" ValidationGroup="Info"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
