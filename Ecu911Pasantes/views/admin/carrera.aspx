<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/admin.Master" AutoEventWireup="true" CodeBehind="carrera.aspx.cs" Inherits="Ecu911Pasantes.views.admin.carrera" %>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="universidades.aspx">Listado de Carreras</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Registrar una Carrera</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-9">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-3 col-form-label">Nombre de la Carrera</label>
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtNombre" OnTextChanged="txtNombre_TextChanged" TextMode="SingleLine" CssClass="form-control" autocomplete="off" placeholder="Ingrese la carrera" runat="server" style="text-transform:uppercase;"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ForeColor="Red" runat="server" ErrorMessage="La Carrera es requerida" ControlToValidate="txtNombre" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="col-3">
