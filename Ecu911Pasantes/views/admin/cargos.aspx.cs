...
namespace Ecu911Pasantes.views.admin
{
    public partial class cargos : System.Web.UI.Page
    {
        ...
        protected void grvCargo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("~/views/admin/cargo.aspx?cod=" + codigo, true);
            }
        ...
        protected void grvCargo_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                string estado = DataBinder.Eval(e.Row.DataItem, "Cargo_estado").ToString();
        ...
        {
            Response.Redirect("~/views/admin/cargo.aspx");
        }

        private void cargarCargos()
        {
            var listaCargos = dc.CargarCargos();
            if (listaCargos != null)
            {
                grvCargo.DataSource = listaCargos;
                grvCargo.DataBind();
            }
}
    }
