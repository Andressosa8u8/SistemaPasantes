...
{
    public partial class proyectosCulminados : System.Web.UI.Page
    {
        ...
        private void CargarHorasCulminadas()
        {
            ...
            grvCulminados.DataSource = lista;
            grvCulminados.DataBind();
        }

        protected void grvCulminados_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "Descargar")
            {
                ...
                foreach (var item in certificado)
                {
                    ...
                    string carrera = item.Carre_nombre;
                    string proyecto = item.Nombre;
                    string universidad = item.Uni_nombre;
