...
namespace Ecu911Pasantes.views.responsable
{
    public partial class pasantes : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/views/responsable/pasante.aspx");
        }
        ...
        protected void grvPasantes_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("~/views/responsable/pasante.aspx?cod=" + codigo, true);
            }
            else if (e.CommandName == "Detalles")
            {
                Response.Redirect("~/views/responsable/detallePasante.aspx?cod=" + codigo, true);
            }
