<%@ Page Title="" Language="C#" MasterPageFile="~/views/responsable/responsable.Master" AutoEventWireup="true" CodeBehind="responsables.aspx.cs" Inherits="Ecu911Pasantes.views.responsable.responsables" %>
                        ...
                        <asp:GridView ID="grvResponsables" AutoGenerateColumns="False" OnRowDataBound="grvResponsables_RowDataBound" EmptyDataText="No hay datos disponibles en la tabla." CssClass="table table-centered w-100 dt-responsive nowrap" OnRowCommand="grvResponsables_RowCommand" GridLines="None" Width="100%" runat="server">
                            <Columns>
                                <asp:TemplateField HeaderText="Cedula">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lblCedula" CommandArgument='<%#Eval("Usu_id")%>' CommandName="Detalles" runat="server">
                                            <asp:Label ID="Cedula" runat="server" Text='<%#Eval("Cedula")%>'></asp:Label></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Area">
                                    <ItemTemplate>
                                        <asp:Label ID="Area_nombre" runat="server" Text='<%#Eval("Area_nombre")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Cargo">
                                    <ItemTemplate>
                                        <asp:Label ID="Cargo_nombre" runat="server" Text='<%#Eval("Cargo_nombre")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
