<%@ Page Title="" Language="C#" MasterPageFile="~/views/responsable/responsable.Master" AutoEventWireup="true" CodeBehind="pasantes.aspx.cs" Inherits="Ecu911Pasantes.views.responsable.pasantes" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphContenido" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="grvPasantes"/>
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
