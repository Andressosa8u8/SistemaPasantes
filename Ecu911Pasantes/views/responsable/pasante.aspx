<%@ Page Title="" Language="C#" MasterPageFile="~/views/responsable/responsable.Master" AutoEventWireup="true" CodeBehind="pasante.aspx.cs" Inherits="Ecu911Pasantes.views.responsable.pasante" %>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="pasantes.aspx">Listado de pasantes</a></li>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtPass" TextMode="Password" CssClass="form-control" placeholder="Ingrese la contraseña" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <asp:TextBox ID="txtConfirmar" TextMode="Password" CssClass="form-control" placeholder="Confirme la contraseña" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtPrimerNombre" type="text" CssClass="form-control" placeholder="Ingrese su primer nombre" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <asp:TextBox ID="txtSegundoNombre" type="text" CssClass="form-control" placeholder="Ingrese su segundo nombre" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtPrimerApellido" type="text" CssClass="form-control" placeholder="Ingrese su primer apellido" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <asp:TextBox ID="txtSegundoApellido" type="text" CssClass="form-control" placeholder="Ingrese su segundo apellido" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtDireccion" type="text" CssClass="form-control" placeholder="Ingrese la dirección" runat="server" autocomplete="off" required="true"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <asp:TextBox ID="txtEmail" type="text" CssClass="form-control" placeholder="Ingrese el correo electronico" runat="server" autocomplete="off" required="true"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtCelular" TextMode="Phone" AutoCompleteType="Cellular" MaxLength="10" CssClass="form-control" placeholder="Ingrese el numero de celular" autocomplete="off" Style="text-transform: uppercase;" runat="server" required="true"></asp:TextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                                        ValidationGroup="Info" ForeColor="Red" Display="Dynamic"
                                        ErrorMessage="Ingrese correctamente su numero de telefono"
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <%--<asp:TextBox ID="txtArea" type="text" CssClass="form-control" placeholder="Ingrese el area de trabajo" autocomplete="off" runat="server" Style="text-transform: uppercase;" required="true"></asp:TextBox>--%>
                                    <asp:DropDownList ID="ddlCentro" CssClass="form-control select2" data-toggle="select2" runat="server" required="true">
                                        <asp:ListItem Value="0">Seleccione el centro</asp:ListItem>
                                    </asp:DropDownList>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" ForeColor="Red" runat="server" ErrorMessage="La area de trabajo es requerida" ControlToValidate="ddlCentro" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    ...
                                    <asp:DropDownList ID="ddlUniversidad" CssClass="form-control select2" data-toggle="select2" runat="server" required="true">
                                        <asp:ListItem Value="0">Seleccione la universidad</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" ForeColor="Red" runat="server" ErrorMessage="La universidad es requerida" ControlToValidate="ddlUniversidad" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtNivel" TextMode="Number" CssClass="form-control" placeholder="Ingrese el nivel de semestre" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <asp:DropDownList ID="ddlActividad" CssClass="form-control" runat="server" required="true">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtCodEcu" CssClass="multisteps-form__input form-control" placeholder="Ingrese el codigo del ECU" runat="server" autocomplete="off" Style="text-transform: uppercase;" required="true"></asp:TextBox>
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-4 col-form-label">Horas requeridas para culminar el proceso</label>
                                <div class="col-sm-12 col-md-8">
                                    <asp:TextBox ID="txtHorasR" MaxLength="3" CssClass="form-control" placeholder="Horas requeridas" autocomplete="off" Style="text-transform: uppercase;" runat="server" required="true"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator20" ForeColor="Red" runat="server" ErrorMessage="El codigo del ECU es requerido" ControlToValidate="txtHorasR" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>

                    </div>
                    <%---ADICIÓN DE NUEVO CAMPO - HORAS NECESARIAS PARA CULMINAR VINCULACIÓN O PRÁCTICAS---%>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
